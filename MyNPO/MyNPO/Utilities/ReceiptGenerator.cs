...
namespace MyNPO.Utilities
{
    ...
    public static class ReceiptGenerator
    {
        ...
        {
            var attachmentName = "Invoice_" + donation.Name + "_" + report.TransactionID + ".pdf";
            ...
            dt.Columns.AddRange(new DataColumn[3]
            {
                ...
                new DataColumn("DonationAmount", typeof(int))
            });
            ...
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Image gif = Image.GetInstance("http://saibabaseattle.com/pics/saibaba-seattle-logo.png");
